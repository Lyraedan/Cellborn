...
public class WeaponTripleBarrelShotgun : WeaponBase
{
    ...
    public override void Fire()
    {
        for (int i = 0; i < numberOfShots; i++)
        {
            ...
            GameObject proj = Instantiate(projectile, WeaponManager.instance.tripleFirepoint.transform.position, Quaternion.Euler(0, yRot, 0));
