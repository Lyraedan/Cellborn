...
public class WeaponDualzi : WeaponBase
{
    ...
    public override void Fire()
    {
        ...
        angle = accuracy;
        GameObject proj = Instantiate(projectile, WeaponManager.instance.uziFirepoint.transform.position, Quaternion.Euler(0, yRot, 0));
